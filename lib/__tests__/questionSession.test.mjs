...
const mocks = {
  ...
  './db': data('export const saveAnswer = async () => { if (globalThis.failAnswerSave) throw new Error(\'SQLITE_FULL\'); }; export const replaceRecordings = async () => {}; export const createSession = async () => 1;'),
