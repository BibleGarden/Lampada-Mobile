...
При наличии `passage.verses` текст карточки и полной читалки собирается из
структурированных стихов, а диапазон `highlight.passage` выделяет ключевые стихи
в нумерации выбранного перевода. Клиент использует verse-level представление
только когда оно точно восстанавливает `passage.text`; старые снимки без массива
и неконсистентные ответы отображаются прежним сплошным текстом без эвристик.
