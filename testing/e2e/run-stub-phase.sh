...
EVIDENCE=/Users/maria/Desktop/Dev/cep/pray/testing/evidence/2026-09-20-stub
mkdir -p "$EVIDENCE"
...
maestro test testing/e2e/ios-update-soft.yaml
...
maestro test testing/e2e/ios-update-hard.yaml
...
maestro test testing/e2e/ios-jrn-010-011-transcribe.yaml

step "JRN-012a: ошибка транскрипции"
control '{"transcription":"fail"}'
maestro test testing/e2e/ios-jrn-012a-transcription-error.yaml

step "JRN-012b: повтор сохраняет текст"
control '{"transcription":"ok"}'
maestro test testing/e2e/ios-jrn-012b-transcription-retry.yaml

step "JRN-013a: закрытие во время расшифровки"
control '{"transcription":"delay"}'
maestro test testing/e2e/ios-jrn-013a-close-during.yaml

step "JRN-013b: удаление во время расшифровки"
maestro test testing/e2e/ios-jrn-013b-delete-during.yaml
control '{"transcription":"ok"}'
...
maestro test testing/e2e/ios-stage05-ai-late-stub.yaml
control '{"questionDelayMs":0}'

step "SCR-001: навигация по отрывкам"
control '{"resetScripture":true}'
maestro test testing/e2e/ios-stage06-scr-001-navigation.yaml

step "SCR-002a/b: избранное переживает перезапуск"
control '{"resetScripture":true}'
maestro test testing/e2e/ios-stage06-scr-002a-favorite-relaunch.yaml
control '{"resetScripture":true}'
maestro test testing/e2e/ios-stage06-scr-002b-favorite-relaunch.yaml

step "Legacy-избранное: миграция"
bash testing/e2e/seed-legacy-favorites.sh
maestro test testing/e2e/ios-scripture-legacy-favorites.yaml
